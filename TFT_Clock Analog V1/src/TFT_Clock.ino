...
uint16_t osx=88, osy=88, omx=88, omy=88, ohx=88, ohy=88;  // Saved H, M, S x & y coords
...
void setup(void) {
  ...
  for(int i = 0; i<360; i+= 30) {
    ...
    // tft.setTextSize(1);
    // tft.setCursor(x1-2, yy1+3);
    // //tft.println(String(number[i]).c_str());
  }
...
*/
  ...
  tft.drawCentreString("Time flies",64,195,4);
